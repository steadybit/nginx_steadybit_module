# Makefile for building ngx_steadybit_sleep_module as a dynamic module in build/ directory
...
MODULE_SRC = $(MODULE_DIR)/ngx_steadybit_sleep_module.c
MODULE_CONFIG = $(MODULE_DIR)/config
MODULE_NAME = ngx_steadybit_sleep_module
...
$(NGINX_SRC_DIR)/src/http/modules/ngx_steadybit_sleep_module.c: $(MODULE_SRC) | $(NGINX_SRC_DIR)/src/http/modules
...
$(MODULE_SO): $(NGINX_SRC_DIR) $(NGINX_SRC_DIR)/src/http/modules/ngx_steadybit_sleep_module.c $(NGINX_SRC_DIR)/src/http/modules/config
